...
public class ClearHeightPanel_Static : StaticUi
{
    ...
    void Update()
    {
        ...
        {
            ModelMeasure_HightDistance();
        }
        else if (MainPanel_Static.allModelAlphaValue == 0 && MainPanel_Static.realModel != 1)
        {
            RealMeasure_HightDistance();
        }
        else
        {
            Measure_HightDistance();
        }
        SetLabelSize();
    }
    void OnDisable()
    ...
    public void RealMeasure_HightDistance()
    {
    ...
    public void ModelMeasure_HightDistance()
    {
        if (Input.GetMouseButtonDown(0))
        {
            if (!existPoint)
    ...
    public void Measure_HightDistance()
    {
        if (Input.GetMouseButtonDown(0))
        {
            if (!existPoint)
